...
public class Comandos {
	...
	public List<String> products(){
		...
		lst.add("description: An apple mobile which is nothin like apple");
		lst.add("discountPercentage: 12.96");
		lst.add("rating: 4.69");
		lst.add("stock: 94");
		lst.add("brand: Apple");
		lst.add("category: smartphones");
		lst.add("thumnnail: https://i.dummyjson.com/data/products/1/thumnnail.jpg");
		...
		lst.add("brand: Apple");
		lst.add("category: smartphones");
		lst.add("thumnnail: https://i.dummyjson.com/data/products/2/thumnnail.jpg");
		...
		lst.add("category: smartphones");
		lst.add("thumnnail: https://i.dummyjson.com/data/products/3/thumnnail.jpg");
		...
		lst.add("brand: OPPO");
		lst.add("category: smartphones");
		lst.add("thumnnail: https://i.dummyjson.com/data/products/4/thumnnail.jpg");
		return lst;
	}
